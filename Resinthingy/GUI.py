...
def ReadInputs():
    ...
    return (twistAngle, tubeLength, tubeDiameter, str(0), str(0), str(0), str(0)) #coldDrawRatio, FRAngle, coilAngle,MandrelDiameter)
...
Title = tk.Label(text='YoUrgAY', font=("Courier", 14, 'bold')).pack()
...
TubeFrame_Label = tk.Label(master=TubePropertiesFrame, text='Options', font=("Courier", 12, 'bold')).pack(side='top', ipadx=0, padx=0, pady=0)

TubeLengthFrame = tk.Frame(master=TubePropertiesFrame, width=400)
TubeLengthFrame.pack(fill=tk.BOTH, side=tk.TOP, expand=True)

TubeLength_Label = tk.Label(master=TubeLengthFrame, text='Extrusion Speed', font=("Courier", 12, 'bold')).pack(side='left', ipadx=0, padx=10, pady=0)
TubeLength_entry = tk.Entry(TubeLengthFrame)
TubeLength_entry.insert(0,'220')
...
TubeDiameter_Label = tk.Label(master=TubeDiameterFrame, text='Pitch', font=("Courier", 12, 'bold')).pack(side='left', ipadx=0, padx=10, pady=0)
TubeDiameter_entry = tk.Entry(TubeDiameterFrame)
TubeDiameter_entry.insert(0,'2.5')
TubeDiameter_entry.pack(side='left', ipadx=0, padx=0, pady=0)



TwistAngleFrame = tk.Frame(master=TubePropertiesFrame, width=400)
TwistAngleFrame.pack(fill=tk.BOTH, side=tk.TOP, expand=True)
TwistAngle_Label = tk.Label(master=TwistAngleFrame, text='Calibration Length', font=("Courier", 12, 'bold')).pack(side='left', ipadx=0, padx=10, pady=0)
...
# MandrelDiameter_Label = tk.Label(master=MandrelDiameterFrame, text='L/s', font=("Courier", 12, 'bold')).pack(side='left', ipadx=0, padx=10, pady=0)
...
# coldDrawRatio_entry.insert(0,'2.5')
...
ControlsFrame_Label = tk.Label(master=ControlsFrame, text='Buttons', font=("Courier", 12, 'bold')).pack(side='top', ipadx=0, padx=0, pady=0)
...
#                                        ).pack(side='left', ipadx=10, padx=10, pady=10)
#
# SpinButton = tk.Button(MiddleRowControlsFrame,
#                                        text="Spin",
#                                        command= lambda: packAndSendMsg('K'),
#                                        height=3,
#                                        fg="black",
#                                        width=10,
#                                        bd=5,
